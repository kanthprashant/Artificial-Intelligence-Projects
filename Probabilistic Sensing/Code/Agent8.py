...
def plan(fringe, target, t_pMax, d_grid, k_base):
    ...
    # if there is no path to identified target, all possible valid cells would have been visited
...
if solvable:
    ...
    # track visited cells, used in calculation of Pmax(finding target)
    visited = {}
    ...
    while not(flag):
        ...
        if p_status == 1:
            ...
            print("Movements: {}, Examinations: {}, Total action: {}".format(ag8_moves, ag8_exams, ag8_cost))
            flag = True
