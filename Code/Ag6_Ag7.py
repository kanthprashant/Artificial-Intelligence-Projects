...
plt.legend(["Agent 6 Actions", "Agent 7 Actions"], loc = 'lower right')
plt.savefig('Agent6_7_actions.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.legend(["Agent 6 Movements", "Agent 7 Movements"], loc = 'lower right')
plt.savefig('Agent6_7_moves.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.legend(["Agent 6 Examinations", "Agent 7 Examinations"], loc = 'lower right')
plt.savefig('Agent6_7_exams.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.legend(["Agent 6 (Moves / Exams)", "Agent 7 (Moves / Exams)"], loc = 'lower right')
plt.savefig('Agent6_7_movesByExams.png', dpi=300, bbox_inches='tight')
plt.show()

# change directory to write files
os.chdir(present_dir + "/Data")
...
with open('g7_moves.csv', 'w', encoding='UTF8', newline='') as n:
    writer = csv.writer(n)
...
with open('ag6_movesByActions.csv', 'w', encoding='UTF8', newline='') as g:
    writer = csv.writer(g)
    writer.writerows(ag6_movesByActions)

with open('ag7_movesByActions.csv', 'w', encoding='UTF8', newline='') as h:
    writer = csv.writer(h)
